...
The Multi-Agent Craftax benchmark is hosted on GitHub and is maintained by its authors.

## How can the manager of the benchmark be contacted?

The manager of the open-source repository can be contacted by the following email: b2alomar [AT] uwaterloo [DOT] ca.
...
This document was adapted from the [Craftax maintenance document](https://github.com/MichaelTMatthews/Craftax/blob/main/MAINTENANCE.md).
...
from craftax_coop.renderer.renderer_symbolic import render_craftax_symbolic
...
class CraftaxCoopSymbolicEnv(MultiAgentEnv):
    def __init__(
        ...
        env_params_kwargs: dict = None,
        static_env_params_kwargs: dict = None,
    ):
